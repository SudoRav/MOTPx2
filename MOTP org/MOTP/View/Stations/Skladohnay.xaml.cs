...
namespace MOTP.View.Stations
{
    public partial class Skladohnay : UserControl
    {
                    ...
                    switch (CBType.SelectedIndex)
                    {
                        case 0:
                            _home.AddProd(Stat.Skladohnay._listPal, Stat.Skladohnay._listGM, Stat.Skladohnay._listMesh, Stat.Skladohnay._listCont, Stat.Skladohnay._listSave, Stat.Skladohnay._listZas,
                                              Stat.Skladohnay._listPal, TBNacl, TBPlmb, "паллет", ListPal); break;
                        case 1:
                            _home.AddProd(Stat.Skladohnay._listPal, Stat.Skladohnay._listGM, Stat.Skladohnay._listMesh, Stat.Skladohnay._listCont, Stat.Skladohnay._listSave, Stat.Skladohnay._listZas,
                                              Stat.Skladohnay._listGM, TBNacl, TBPlmb, "гм", ListGM); break;

                        case 4:
                            _home.AddProd(Stat.Skladohnay._listPal, Stat.Skladohnay._listGM, Stat.Skladohnay._listMesh, Stat.Skladohnay._listCont, Stat.Skladohnay._listSave, Stat.Skladohnay._listZas,
                                              Stat.Skladohnay._listSave, TBNacl, TBPlmb, "сейфпакет"); break;
                        case 5:
                            _home.AddProd(Stat.Skladohnay._listPal, Stat.Skladohnay._listGM, Stat.Skladohnay._listMesh, Stat.Skladohnay._listCont, Stat.Skladohnay._listSave, Stat.Skladohnay._listZas,
                                              Stat.Skladohnay._listZas, TBNacl, TBPlmb, "засыл"); break;
                    }
                }
            ...
            if (e.Key == Key.Enter)
            {
                ...
                if (CBType.SelectedIndex == 2 || CBType.SelectedIndex == 3)
                {
                    switch (CBType.SelectedIndex)
                    {
                        case 2:
                            _home.AddProd(Stat.Skladohnay._listPal, Stat.Skladohnay._listGM, Stat.Skladohnay._listMesh, Stat.Skladohnay._listCont, Stat.Skladohnay._listSave, Stat.Skladohnay._listZas,
                                              Stat.Skladohnay._listMesh, TBNacl, TBPlmb, "мешок", ListMesh); break;
                        case 3:
                            _home.AddProd(Stat.Skladohnay._listPal, Stat.Skladohnay._listGM, Stat.Skladohnay._listMesh, Stat.Skladohnay._listCont, Stat.Skladohnay._listSave, Stat.Skladohnay._listZas,
                                              Stat.Skladohnay._listCont, TBNacl, TBPlmb, "контейнер", ListCont); break;
                    }
                }
            }
        }
        ...
        {
            _home.ListSelectionWeb(ListPal, Stat.Skladohnay._listPal, false);
        }

        private void ListGM_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            _home.ListSelectionWeb(ListGM, Stat.Skladohnay._listGM, false);
        }

        private void ListMesh_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            _home.ListSelectionWeb(ListMesh, Stat.Skladohnay._listMesh, true);
        }

        private void ListCont_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            _home.ListSelectionWeb(ListCont, Stat.Skladohnay._listCont, true);
        }
        ...
        private void RTBMarch_Loaded(object sender, RoutedEventArgs e)
        {
            FlowDocument document = new FlowDocument();
            Paragraph paragraph = new Paragraph();
            paragraph.Inlines.Add(new Bold(new Run(Stat.Skladohnay.march)));
            document.Blocks.Add(paragraph);
        ...
        {
            TB_Martch2.Text = Stat.Skladohnay.march2;
        }
        ...
        {
            Stat.Skladohnay.march = new TextRange(RTBMarch.Document.ContentStart, RTBMarch.Document.ContentEnd).Text;
        }

        private void TB_Martch2_LostFocus(object sender, RoutedEventArgs e)
        {
            Stat.Skladohnay.march2 = TB_Martch2.Text;
        }
        ...
        {
            _home.OpenDop(Stat.Skladohnay._listSave, Stat.Skladohnay._listZas);
        }
        ...
        {
            _home.FormDoc(Stat.Skladohnay._listPal, Stat.Skladohnay._listGM, Stat.Skladohnay._listMesh, Stat.Skladohnay._listCont, Stat.Skladohnay._listSave, Stat.Skladohnay._listZas,
                          RTBoooinn, TB_FIO, RTBMarch, TB_Phone, RTBdt, TB_Auto1, TB_Auto2, Stat.Skladohnay.sdach, Stat.Skladohnay.poluch);
        }
    }
}
