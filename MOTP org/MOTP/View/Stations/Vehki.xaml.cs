...
namespace MOTP.View.Stations
{
    public partial class Vehki : UserControl
    {
                    ...
                    switch (CBType.SelectedIndex)
                    {
                        case 0:
                            _home.AddProd(Stat.Vehki._listPal, Stat.Vehki._listGM, Stat.Vehki._listMesh, Stat.Vehki._listCont, Stat.Vehki._listSave, Stat.Vehki._listZas,
                                              Stat.Vehki._listPal, TBNacl, TBPlmb, "паллет", ListPal); break;
                        case 1:
                            _home.AddProd(Stat.Vehki._listPal, Stat.Vehki._listGM, Stat.Vehki._listMesh, Stat.Vehki._listCont, Stat.Vehki._listSave, Stat.Vehki._listZas,
                                              Stat.Vehki._listGM, TBNacl, TBPlmb, "гм", ListGM); break;

                        case 4:
                            _home.AddProd(Stat.Vehki._listPal, Stat.Vehki._listGM, Stat.Vehki._listMesh, Stat.Vehki._listCont, Stat.Vehki._listSave, Stat.Vehki._listZas,
                                              Stat.Vehki._listSave, TBNacl, TBPlmb, "сейфпакет"); break;
                        case 5:
                            _home.AddProd(Stat.Vehki._listPal, Stat.Vehki._listGM, Stat.Vehki._listMesh, Stat.Vehki._listCont, Stat.Vehki._listSave, Stat.Vehki._listZas,
                                              Stat.Vehki._listZas, TBNacl, TBPlmb, "засыл"); break;
                    }
                }
            ...
            if (e.Key == Key.Enter)
            {
                ...
                if (CBType.SelectedIndex == 2 || CBType.SelectedIndex == 3)
                {
                    switch (CBType.SelectedIndex)
                    {
                        case 2:
                            _home.AddProd(Stat.Vehki._listPal, Stat.Vehki._listGM, Stat.Vehki._listMesh, Stat.Vehki._listCont, Stat.Vehki._listSave, Stat.Vehki._listZas,
                                              Stat.Vehki._listMesh, TBNacl, TBPlmb, "мешок", ListMesh); break;
                        case 3:
                            _home.AddProd(Stat.Vehki._listPal, Stat.Vehki._listGM, Stat.Vehki._listMesh, Stat.Vehki._listCont, Stat.Vehki._listSave, Stat.Vehki._listZas,
                                              Stat.Vehki._listCont, TBNacl, TBPlmb, "контейнер", ListCont); break;
                    }
                }
            }
        }
        ...
        private void RTBMarch_Loaded(object sender, RoutedEventArgs e)
        {
            FlowDocument document = new FlowDocument();
            Paragraph paragraph = new Paragraph();
            paragraph.Inlines.Add(new Bold(new Run(Stat.Vehki.march)));
            document.Blocks.Add(paragraph);
        ...
        {
            TB_Martch2.Text = Stat.Vehki.march2;
        }
        ...
        {
            Stat.Vehki.march = new TextRange(RTBMarch.Document.ContentStart, RTBMarch.Document.ContentEnd).Text;
        }

        private void TB_Martch2_LostFocus(object sender, RoutedEventArgs e)
        {
            Stat.Vehki.march2 = TB_Martch2.Text;
        }
        ...
        {
            _home.OpenDop(Stat.Vehki._listSave, Stat.Vehki._listZas);
        }
        ...
        {
            _home.FormDoc(Stat.Vehki._listPal, Stat.Vehki._listGM, Stat.Vehki._listMesh, Stat.Vehki._listCont, Stat.Vehki._listSave, Stat.Vehki._listZas,
                          RTBoooinn, TB_FIO, RTBMarch, TB_Phone, RTBdt, TB_Auto1, TB_Auto2, Stat.Vehki.sdach, Stat.Vehki.poluch);
        }
    }
}
