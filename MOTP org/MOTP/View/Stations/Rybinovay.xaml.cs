...
namespace MOTP.View.Stations
{
    public partial class Rybinovay : UserControl
    {
                    ...
                    switch (CBType.SelectedIndex)
                    {
                        case 0:
                            _home.AddProd(Stat.Rybinovay._listPal, Stat.Rybinovay._listGM, Stat.Rybinovay._listMesh, Stat.Rybinovay._listCont, Stat.Rybinovay._listSave, Stat.Rybinovay._listZas,
                                              Stat.Rybinovay._listPal, TBNacl, TBPlmb, "паллет", ListPal); break;
                        case 1:
                            _home.AddProd(Stat.Rybinovay._listPal, Stat.Rybinovay._listGM, Stat.Rybinovay._listMesh, Stat.Rybinovay._listCont, Stat.Rybinovay._listSave, Stat.Rybinovay._listZas,
                                              Stat.Rybinovay._listGM, TBNacl, TBPlmb, "гм", ListGM); break;

                        case 4:
                            _home.AddProd(Stat.Rybinovay._listPal, Stat.Rybinovay._listGM, Stat.Rybinovay._listMesh, Stat.Rybinovay._listCont, Stat.Rybinovay._listSave, Stat.Rybinovay._listZas,
                                              Stat.Rybinovay._listSave, TBNacl, TBPlmb, "сейфпакет"); break;
                        case 5:
                            _home.AddProd(Stat.Rybinovay._listPal, Stat.Rybinovay._listGM, Stat.Rybinovay._listMesh, Stat.Rybinovay._listCont, Stat.Rybinovay._listSave, Stat.Rybinovay._listZas,
                                              Stat.Rybinovay._listZas, TBNacl, TBPlmb, "засыл"); break;
                    }
                }
            ...
            if (e.Key == Key.Enter)
            {
                ...
                if (CBType.SelectedIndex == 2 || CBType.SelectedIndex == 3)
                {
                    switch (CBType.SelectedIndex)
                    {
                        case 2:
                            _home.AddProd(Stat.Rybinovay._listPal, Stat.Rybinovay._listGM, Stat.Rybinovay._listMesh, Stat.Rybinovay._listCont, Stat.Rybinovay._listSave, Stat.Rybinovay._listZas,
                                              Stat.Rybinovay._listMesh, TBNacl, TBPlmb, "мешок", ListMesh); break;
                        case 3:
                            _home.AddProd(Stat.Rybinovay._listPal, Stat.Rybinovay._listGM, Stat.Rybinovay._listMesh, Stat.Rybinovay._listCont, Stat.Rybinovay._listSave, Stat.Rybinovay._listZas,
                                              Stat.Rybinovay._listCont, TBNacl, TBPlmb, "контейнер", ListCont); break;
                    }
                }
            }
        }
        ...
        {
            _home.ListSelectionWeb(ListPal, Stat.Rybinovay._listPal, false);
        }

        private void ListGM_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            _home.ListSelectionWeb(ListGM, Stat.Rybinovay._listGM, false);
        }

        private void ListMesh_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            _home.ListSelectionWeb(ListMesh, Stat.Rybinovay._listMesh, true);
        }

        private void ListCont_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            _home.ListSelectionWeb(ListCont, Stat.Rybinovay._listCont, true);
        }
        ...
        private void RTBMarch_Loaded(object sender, RoutedEventArgs e)
        {
            FlowDocument document = new FlowDocument();
            Paragraph paragraph = new Paragraph();
            paragraph.Inlines.Add(new Bold(new Run(Stat.Rybinovay.march)));
            document.Blocks.Add(paragraph);
        ...
        {
            TB_Martch2.Text = Stat.Rybinovay.march2;
        }
        ...
        {
            Stat.Rybinovay.march = new TextRange(RTBMarch.Document.ContentStart, RTBMarch.Document.ContentEnd).Text;
        }

        private void TB_Martch2_LostFocus(object sender, RoutedEventArgs e)
        {
            Stat.Rybinovay.march2 = TB_Martch2.Text;
        }
        ...
        {
            _home.OpenDop(Stat.Rybinovay._listSave, Stat.Rybinovay._listZas);
        }
        ...
        {
            _home.FormDoc(Stat.Rybinovay._listPal, Stat.Rybinovay._listGM, Stat.Rybinovay._listMesh, Stat.Rybinovay._listCont, Stat.Rybinovay._listSave, Stat.Rybinovay._listZas,
                          RTBoooinn, TB_FIO, RTBMarch, TB_Phone, RTBdt, TB_Auto1, TB_Auto2, Stat.Rybinovay.sdach, Stat.Rybinovay.poluch);
        }
    }
}
