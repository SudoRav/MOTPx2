...
namespace MOTP.View.Stations
{
    public partial class Marta : UserControl
    {
                    ...
                    switch (CBType.SelectedIndex)
                    {
                        case 0:
                            _home.AddProd(Stat.Marta._listPal, Stat.Marta._listGM, Stat.Marta._listMesh, Stat.Marta._listCont, Stat.Marta._listSave, Stat.Marta._listZas,
                                              Stat.Marta._listPal, TBNacl, TBPlmb, "паллет", ListPal); break;
                        case 1:
                            _home.AddProd(Stat.Marta._listPal, Stat.Marta._listGM, Stat.Marta._listMesh, Stat.Marta._listCont, Stat.Marta._listSave, Stat.Marta._listZas,
                                              Stat.Marta._listGM, TBNacl, TBPlmb, "гм", ListGM); break;

                        case 4:
                            _home.AddProd(Stat.Marta._listPal, Stat.Marta._listGM, Stat.Marta._listMesh, Stat.Marta._listCont, Stat.Marta._listSave, Stat.Marta._listZas,
                                              Stat.Marta._listSave, TBNacl, TBPlmb, "сейфпакет"); break;
                        case 5:
                            _home.AddProd(Stat.Marta._listPal, Stat.Marta._listGM, Stat.Marta._listMesh, Stat.Marta._listCont, Stat.Marta._listSave, Stat.Marta._listZas,
                                              Stat.Marta._listZas, TBNacl, TBPlmb, "засыл"); break;
                    }
                }
            ...
            if (e.Key == Key.Enter)
            {
                ...
                if (CBType.SelectedIndex == 2 || CBType.SelectedIndex == 3)
                {
                    switch (CBType.SelectedIndex)
                    {
                        case 2:
                            _home.AddProd(Stat.Marta._listPal, Stat.Marta._listGM, Stat.Marta._listMesh, Stat.Marta._listCont, Stat.Marta._listSave, Stat.Marta._listZas,
                                              Stat.Marta._listMesh, TBNacl, TBPlmb, "мешок", ListMesh); break;
                        case 3:
                            _home.AddProd(Stat.Marta._listPal, Stat.Marta._listGM, Stat.Marta._listMesh, Stat.Marta._listCont, Stat.Marta._listSave, Stat.Marta._listZas,
                                              Stat.Marta._listCont, TBNacl, TBPlmb, "контейнер", ListCont); break;
                    }
                }
            }
        }
        ...
        private void RTBMarch_Loaded(object sender, RoutedEventArgs e)
        {
            FlowDocument document = new FlowDocument();
            Paragraph paragraph = new Paragraph();
            paragraph.Inlines.Add(new Bold(new Run(Stat.Marta.march)));
            document.Blocks.Add(paragraph);
        ...
        {
            TB_Martch2.Text = Stat.Marta.march2;
        }
        ...
        {
            Stat.Marta.march = new TextRange(RTBMarch.Document.ContentStart, RTBMarch.Document.ContentEnd).Text;
        }

        private void TB_Martch2_LostFocus(object sender, RoutedEventArgs e)
        {
            Stat.Marta.march2 = TB_Martch2.Text;
        }
        ...
        {
            _home.OpenDop(Stat.Marta._listSave, Stat.Marta._listZas);
        }
        ...
        {
            _home.FormDoc(Stat.Marta._listPal, Stat.Marta._listGM, Stat.Marta._listMesh, Stat.Marta._listCont, Stat.Marta._listSave, Stat.Marta._listZas,
                          RTBoooinn, TB_FIO, RTBMarch, TB_Phone, RTBdt, TB_Auto1, TB_Auto2, Stat.Marta.sdach, Stat.Marta.poluch);
        }
    }
}
