...
namespace MOTP.View.Stations
{
    public partial class Puhkino : UserControl
    {
                    ...
                    switch (CBType.SelectedIndex)
                    {
                        case 0:
                            _home.AddProd(Stat.Puhkino._listPal, Stat.Puhkino._listGM, Stat.Puhkino._listMesh, Stat.Puhkino._listCont, Stat.Puhkino._listSave, Stat.Puhkino._listZas,
                                              Stat.Puhkino._listPal, TBNacl, TBPlmb, "паллет", ListPal); break;
                        case 1:
                            _home.AddProd(Stat.Puhkino._listPal, Stat.Puhkino._listGM, Stat.Puhkino._listMesh, Stat.Puhkino._listCont, Stat.Puhkino._listSave, Stat.Puhkino._listZas,
                                              Stat.Puhkino._listGM, TBNacl, TBPlmb, "гм", ListGM); break;

                        case 4:
                            _home.AddProd(Stat.Puhkino._listPal, Stat.Puhkino._listGM, Stat.Puhkino._listMesh, Stat.Puhkino._listCont, Stat.Puhkino._listSave, Stat.Puhkino._listZas,
                                              Stat.Puhkino._listSave, TBNacl, TBPlmb, "сейфпакет"); break;
                        case 5:
                            _home.AddProd(Stat.Puhkino._listPal, Stat.Puhkino._listGM, Stat.Puhkino._listMesh, Stat.Puhkino._listCont, Stat.Puhkino._listSave, Stat.Puhkino._listZas,
                                              Stat.Puhkino._listZas, TBNacl, TBPlmb, "засыл"); break;
                    }
                }
            ...
            if (e.Key == Key.Enter)
            {
                ...
                if (CBType.SelectedIndex == 2 || CBType.SelectedIndex == 3)
                {
                    switch (CBType.SelectedIndex)
                    {
                        case 2:
                            _home.AddProd(Stat.Puhkino._listPal, Stat.Puhkino._listGM, Stat.Puhkino._listMesh, Stat.Puhkino._listCont, Stat.Puhkino._listSave, Stat.Puhkino._listZas,
                                              Stat.Puhkino._listMesh, TBNacl, TBPlmb, "мешок", ListMesh); break;
                        case 3:
                            _home.AddProd(Stat.Puhkino._listPal, Stat.Puhkino._listGM, Stat.Puhkino._listMesh, Stat.Puhkino._listCont, Stat.Puhkino._listSave, Stat.Puhkino._listZas,
                                              Stat.Puhkino._listCont, TBNacl, TBPlmb, "контейнер", ListCont); break;
                    }
                }
            }
        }
        ...
        private void RTBMarch_Loaded(object sender, RoutedEventArgs e)
        {
            FlowDocument document = new FlowDocument();
            Paragraph paragraph = new Paragraph();
            paragraph.Inlines.Add(new Bold(new Run(Stat.Puhkino.march)));
            document.Blocks.Add(paragraph);
        ...
        {
            TB_Martch2.Text = Stat.Puhkino.march2;
        }
        ...
        {
            Stat.Puhkino.march = new TextRange(RTBMarch.Document.ContentStart, RTBMarch.Document.ContentEnd).Text;
        }

        private void TB_Martch2_LostFocus(object sender, RoutedEventArgs e)
        {
            Stat.Puhkino.march2 = TB_Martch2.Text;
        }
        ...
        {
            _home.OpenDop(Stat.Puhkino._listSave, Stat.Puhkino._listZas);
        }
        ...
        {
            _home.FormDoc(Stat.Puhkino._listPal, Stat.Puhkino._listGM, Stat.Puhkino._listMesh, Stat.Puhkino._listCont, Stat.Puhkino._listSave, Stat.Puhkino._listZas,
                          RTBoooinn, TB_FIO, RTBMarch, TB_Phone, RTBdt, TB_Auto1, TB_Auto2, Stat.Puhkino.sdach, Stat.Puhkino.poluch);
        }
    }
}
